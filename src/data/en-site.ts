...
export const enPeople: Record<string, {
  ...
  'master-chen-suixiaochen': { name: 'Suixiaochen Chen', role: 'PhD Student, Class of 2025', research: 'Reactive iron minerals in soils.' },
  'phd-feng-qi': { name: 'Qi Feng', role: 'PhD Student, Class of 2026 (Master-to-PhD Transfer)', research: 'Weathering of sulfidic tailings.' },
  'phd-wu-yuqi': { name: 'Yuqi Wu', role: 'Direct-entry PhD Student, Class of 2023', research: 'Adsorption and transformation of AMF exudates on minerals.', origin: 'Tsinghua University' },
  'master-yang-shuang': { name: 'Shuang Yang', role: 'PhD Student, Class of 2025', note: 'Visiting', research: 'Development of tailing soil structure.', origin: 'China Agricultural University' },
  'master-yang-zijie': { name: 'Zijie Yang', role: 'Master Student, Class of 2025', origin: 'University of Chinese Academy of Sciences' },
  'master-wenqi-li': {
    name: 'Wenqi Li',
    role: 'Former Visiting Master Student, Class of 2024',
    origin: 'China University of Mining and Technology (Beijing)',
    destination: 'China University of Mining and Technology (Beijing)',
  },
  'master-wang-jing': { name: 'Jing Wang', role: 'Master Student, Class of 2024', origin: 'Zhengzhou University' },
  'guest-wang-wenli': {
    name: 'Wenli Wang',
    role: 'Former Visiting Master Student, Class of 2024',
  ...
  'master-li-yanyan': { name: 'Yanyan Li', role: 'Master Student, Class of 2026', origin: 'University of Chinese Academy of Sciences' },
  'master-sheng-linxuan': { name: 'Linxuan Sheng', role: 'Master Student, Class of 2025', note: 'Visiting', origin: 'China University of Geosciences (Beijing)' },
  'guest-wang-yifan': { name: 'Yifan Wang', role: 'Master Student, Class of 2025', note: 'Visiting', origin: 'China University of Geosciences (Beijing)' },
  'guest-wang-hao': { name: 'Hao Wang', role: 'Master Student, Class of 2026', note: 'Visiting', origin: 'China University of Geosciences (Beijing)' },
