...
export const enPeople: Record<string, { name: string; role: string; research?: string; note?: string; origin?: string; destination?: string; bio?: string[] }> = {
  ...
  'master-chen-suixiaochen': { name: 'Suixiaochen Chen', role: 'Master Student' },
  ...
  'master-yang-shuang': { name: 'Shuang Yang', role: 'Master Student', note: 'Visiting', origin: 'China Agricultural University' },
